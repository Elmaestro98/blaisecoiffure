...
export function ProductCatalog({ products, categories }: ProductCatalogProps) {
  ...
  return (
    <section className="border-t border-[#E8D9D5] bg-[#FBF7F5] py-16 sm:py-20">
      <div className="mx-auto max-w-6xl px-4">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-end lg:justify-between">
          ...
          <div className="flex items-center gap-2 text-sm text-[#9C8D89]">
            <PackageOpen className="h-4 w-4 text-[#8E2332]" />
            <span>
